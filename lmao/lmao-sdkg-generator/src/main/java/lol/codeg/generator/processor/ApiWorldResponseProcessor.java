 ...
 */
package lol.codeg.generator.processor;

import lol.codeg.generator.Constants;
...
public class ApiWorldResponseProcessor extends BaseResponseProcessor {
  ...
  static String DEFAULT_RESPONSE_CLASS_NAME = "lol.vo.ResultModel";

  static String DEFAULT_LISTRESPONSE_CLASS_NAME = "lol.vo.ResultListModel";

  static String DEFAULT_PAGERESPONSE_CLASS_NAME = "lol.vo.ResultPageModel";

  static String DEFAULT_RESPONSE_HELPER_CLASS_NAME = "lol.helper.ResultHelper";
