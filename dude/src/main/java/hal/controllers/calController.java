...
public class calController {
    ...
    public ModelAndView launch() {
        ...
        mv.put("speech", "Welcome to cal. This is where you will greet users of your skill.");
    ...
    public ModelAndView petTypeIntent(PetTypeIntent intent) {
        ModelAndView mv = new ModelAndView("basic");
        mv.put("speech", "Welcome to cal. This is where you will handle a custom intent.");
        mv.put("reprompt", "What would you like to do?");
        return mv;
    }
    ...
    public ModelAndView help() {
        ModelAndView mv = new ModelAndView("basic");
        mv.put("speech", "Welcome to cal. This is where users will be directed when asking for help.");
        mv.put("reprompt", "What would you like to do?");
        return mv;
    }
